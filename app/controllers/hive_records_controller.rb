class HiveRecordsController < ApplicationController
  ...
  private
    ...
    def hive_record_params
      params.require(:hive_record).permit(:hive_id_temp, :hive_temperament, :laying_pattern, :eggs_present, :eggs_present_comment, :population, :deep_body, :split_hive, :swarming_imminent, :excessive_drone_cells, :drone_pop_est, :queen_cells, :queen_cells_frame_bottom, :queen_cells_converted, :disease_or_pest, :type_of_disease_pest)
    end
end
